...
void StackTaskApp_MissionAction(void)
{
    ...
    switch(TaskNumber)
    {
        case TASK_DEBUGINFO:
            ...
            uint8_t Command[5] = {0x00U};
            uint8_t Status = ERROR_NONE;
            Command[0] = 0x13U; /*Color Temp Write Only Reg*/
            Command[1] = 0x84U; /*IP Index*/
            Command[2] = 0x01U; /*Table Index*/
            Command[3] = 0x00U; /*undefined*/
            Command[4] = 0x00U; /*undefined*/
            Status = I2C1MDriver_Write(0x08,Command,5U);
